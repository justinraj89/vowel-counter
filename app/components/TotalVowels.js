...
function TotalVowels({ count }) {
  return (
    <div className='mt-4 lg:mt-0'>
        ...
        <p className='text-center font-mono tracking-wide bg-gradient-to-r from-purple-600 via-emerald-500 to-yellow-100 bg-clip-text text-transparent md:text-7xl text-5xl mt-4 animate__animated animate__bounce'>{count}</p>
    </div>
  )
}
