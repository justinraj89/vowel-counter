...
function TotalVowels({ count }) {
  return (
    <div className=''>
        ...
        <p className='text-center tracking-wide bg-gradient-to-r from-purple-600 via-emerald-500 to-yellow-100 bg-clip-text text-transparent md:text-7xl text-5xl mt-4 animate__animated animate__pulse'>{count}</p>
    </div>
  )
}
