...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center overflow-hidden p-4 h-fit mt-16 px-8 ">
      <div className="max-w-md md:max-w-2xl">
        <h1 className="tracking-wide bg-gradient-to-r from-red-600 via-orange-500 to-yellow-100 bg-clip-text text-transparent md:text-7xl text-4xl text-center mt-4 md:mt-14 animate__animated animate__pulse">
          #hashtagGenerator
        </h1>
