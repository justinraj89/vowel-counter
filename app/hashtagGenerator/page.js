  ...
  return (
    <div className="flex flex-col items-center overflow-hidden p-4">
      <div className="max-w-md md:max-w-2xl">
        <h1 className="tracking-wide bg-gradient-to-r from-blue-600 via-orange-500 to-yellow-100 bg-clip-text text-transparent md:text-7xl text-5xl text-center mt-4 md:mt-14 animate__animated animate__pulse">
          #hashtagGenerator
        </h1>
